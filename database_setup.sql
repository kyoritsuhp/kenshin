-- データベースの作成
CREATE DATABASE IF NOT EXISTS monshin CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS questionnaire_responses (
    ...
    health_check_year VARCHAR(100),
    health_check_season VARCHAR(100),

    -- 質問1-3: 薬の使用
    q1_blood_pressure_med TINYINT COMMENT '1:はい, 2:いいえ',
    q1_medicine_name VARCHAR(255) COMMENT '血圧の薬の名前',
    q2_insulin_med TINYINT COMMENT '1:はい, 2:いいえ',
    q2_medicine_name VARCHAR(255) COMMENT 'インスリンの薬の名前',
    q3_cholesterol_med TINYINT COMMENT '1:はい, 2:いいえ',
    q3_medicine_name VARCHAR(255) COMMENT 'コレステロールの薬の名前',
